function [Y,idx,pns,edg,rnd] = round63(X,ser,rnd) %#ok<*ISMAT,*HISTC>
...
% were used to bin the <X> values, and is automatically generated from the
% <pns> values according to the requested <rnd> option.
%
%% Examples %%
%
% >> round63(500, "E12")
